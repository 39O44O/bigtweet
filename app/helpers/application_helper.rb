module ApplicationHelper
  def get_twitter_card_info(hash)
    ...
    if hash.present?
      twitter_card[:url] = "https://bigtweet-390440.herokuapp.com/?=#{hash}"
      twitter_card[:image] = "https://s3-ap-northeast-1.amazonaws.com/bigtweet-20210223-development-#{environment}/images/#{hash}.png"
    else
      twitter_card[:url] = 'https://bigtweet-390440.herokuapp.com/'
